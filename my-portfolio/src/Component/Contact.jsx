            ...
            <Box id="contact" bgColor="#05386B" color="#EDF5E1" mt="5%" p="30px">
                ...
                <Flex direction={{base: "column", sm: "column", lg:"column", xl: "row"}} gap="10px" mt="30px" mb="3%" justifyContent="space-around">
                    <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" gap="10px">
                        <Link id="contact-phone" href="tel:+919930361634"><MdAddIcCall size="3em"/></Link>
                        <Link href="tel:+919930361634"><Text fontSize="lg">+91 9930361634</Text></Link>
                    </Box>
                    <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" gap="10px">
                        <Link id="contact-github" href="https://github.com/Neerav-Khatri" isExternal><BsGithub size="3em"/></Link>
                        <Link href="https://github.com/Neerav-Khatri" isExternal><Text fontSize="lg">Neerav-Khatri</Text></Link>
                    </Box>
                    <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" gap="10px">
                        <Link id="contact-linkedin" href="https://www.linkedin.com/in/neerav-khatri-05084a233" isExternal><BsLinkedin size="3em"/></Link>
                        <Link href="https://www.linkedin.com/in/neerav-khatri-05084a233" isExternal><Text fontSize="lg">Neerav-Khatri</Text></Link>
                    </Box>
                    <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" gap="10px">
                        <Link id="contact-email" href="mailto:khaneerav6337@gmail.com" isExternal><GoMail size="3em"/></Link>
